// Taken from: https://github.com/Nemirtingas/imgui/blob/Linux_X11_backend/backends/imgui_impl_x11.cpp
...
bool ImGui_ImplX11_Init(Display *display, Window window)
{
  ...
  auto *bd = IM_NEW(ImGui_ImplX11_Data)();
